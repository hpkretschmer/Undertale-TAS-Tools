...
# Try { seed: 7429, offset: 437547, final_damage: 663, damage_rolls: 147, patterns: [9, 9, 9, 3, 6, 0, 9, 6, 9, 9, 6, 6, 6, 9], damages: [1743, 1743, 1743, 1386, 1743, 600, 1743, 1743, 1743, 1743, 1638, 1743, 1743, 1743], cost: 484 }

currentSeed = 582820542
# currentSeed = 3964202057
elapsed_sec = 6225
elapsed_nsec = 994234656-33333333
elapsed = elapsed_sec * int(1e6) + elapsed_nsec // int(1e3)
currentMicros = matchSeed(currentSeed, elapsed)
targetSeed = 3964202057
targetState = seedToState(targetSeed)
targetMicros = matchState(targetState, currentMicros)
diff = targetMicros - currentMicros
# print all variables
print("Current Seed: {}".format(currentSeed))
print("Current Micros: {}".format(currentMicros))
print("Target Seed: {}".format(targetSeed))
print("Target State: {}".format(targetState))
print("Target Micros: {}".format(targetMicros))
